...
import static kontroler.KontrolerKorisnickogInterfejsa.formaUbaciPredstavu;
 ...
 * @author Luka
 */
public class formaUbaciPredstavu extends javax.swing.JFrame {

    int x,y;
    ModelTabeleGlumci mtgSvi;
    ModelTabeleGlumci mtgIzabrani;
    /**
     * Creates new form formaUbaciPredstavu
     */
    public formaUbaciPredstavu(ArrayList<Glumac> glumci) {
        initComponents();
       // this.glumci = glumci;
    ...
    private void initComponents() {
        ...
        btnDodaj = new javax.swing.JLabel();
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 349, 500, 130));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 50, 20));
        ...
        btnDodaj.setIcon(new javax.swing.ImageIcon(getClass().getResource("/forme/button_dodaj.png"))); // NOI18N
        btnDodaj.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnDodajMouseClicked(evt);
            }
        });
        jPanel1.add(btnDodaj, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 420, -1, -1));
    ...
    private void btnDodajMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDodajMouseClicked
        KontrolerKorisnickogInterfejsa.getInstanca().ubaciPredstavu(txtNaziv.getText(),txtTrajanje.getText(),txtOpis.getText(),(Reziser)cbReziser.getSelectedItem(),(Zanr)cbZanr.getSelectedItem(),mtgIzabrani.vratiGlumceIzTabele());
...
//            java.util.logging.Logger.getLogger(formaUbaciPredstavu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new formaUbaciPredstavu().setVisible(true);
//            }
//        });
//    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel btnDodaj;
